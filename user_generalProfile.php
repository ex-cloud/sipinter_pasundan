        ...
        <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
          <div class="card card-profile shadow">
            ...
            <div class="text-center">
                ...
                <?php
                      $tampillokasi = mysqli_query($koneksi, "SELECT DISTINCT p.id_user, p.nama_lengkap, p.nik, p.ttl, p.jenis_kelamin, p.alamat, p.kelurahan, p.kecamatan, p.kota, p.provinsi, p.tlp, p.pendidikan, p.pekerjaan, p.status, p.goldar from user b, profil_user p where b.id_user=p.id_user and p.id_user='$_SESSION[id_user]' group by id_user");
                      while ($lihat = mysqli_fetch_array($tampillokasi)){
                      
                      ?>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"><?=$lihat['kota']?>, <?=$lihat['provinsi']?></i>
                </div>
                <?php } ?>
                <div class="h5 font-weight-300">
